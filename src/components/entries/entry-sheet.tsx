  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side='bottom'>
        <SheetHeader>
          <SheetTitle className='font-sans text-xl font-bold'>{entry ? 'Edit fill-up' : 'Add fuel entry'}</SheetTitle>
          <SheetDescription>
            {entry
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This removes the fill-up on {formatDate(entry.date)} at {entry.odometerReading.toLocaleString()} km.
                    The previous entry&apos;s mileage will be recalculated. This can&apos;t be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
